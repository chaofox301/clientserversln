...
//        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=WestWind;Integrated Security=True; Encrypt=False;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BuildVer__3214EC07893AFF46");
        ...
        {
            entity.HasKey(e => e.ManifestItemId).HasName("PK__Manifest__9000192C7A057C20");
        ...
        {
            entity.HasKey(e => e.ShipmentId).HasName("PK__Shipment__5CAD378D8456D7BC");
